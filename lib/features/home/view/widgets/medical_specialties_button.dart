...
/**
 * A button representing a medical department on the home screen.
 * Taps navigate to the SearchByCategoryScreen with the department name.
 */
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SearchByCategoryScreen(departmentName: name),
          ),
        );
      },
