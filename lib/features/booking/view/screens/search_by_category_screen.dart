...
class _SearchByCategoryScreenState extends ConsumerState<SearchByCategoryScreen> {
  ...
  void _loadDoctors() {
    ...
    _doctorsFuture = widget.departmentName.isEmpty
        ? repo.getAllDoctors()
        : repo.getDoctorsByDepartment(widget.departmentName);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: HeaderText(
          text: widget.departmentName.isEmpty ? "Find Care" : widget.departmentName,
          fontsize: 18.sp,
